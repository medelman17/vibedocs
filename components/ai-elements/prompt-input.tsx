...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn("field-sizing-content max-h-32 min-h-0 py-2", className)}
      name="message"
...
export const PromptInputHeader = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={cn("order-first flex-wrap gap-1 pb-0 pt-2", className)}
    {...props}
  />
);
...
export const PromptInputFooter = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={cn("justify-between gap-1 pb-2 pt-0", className)}
    {...props}
  />
);
